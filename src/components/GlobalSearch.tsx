    ...
    >
      <div className="relative flex-1 z-1">
        <input
          ...
          className="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 bg-white text-gray-800 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-800 focus:border-transparent transition duration-200"
        />
